...
using CarRent.src.Infrastructure.Methods.Commands;
using System.Numerics;

namespace CarRent.src.Application.Methods.Commands
{
    public class Reserve : IRequest<Task>
    {
    ...
    public class ReserveHandler : IRequestHandler<Reserve, Task>
    {
        ...
        public async Task<Task> Handle(Reserve request, CancellationToken cancellationToken)
        {
